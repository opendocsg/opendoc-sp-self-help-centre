(function () {
    ...
    var endpoint = null
    var env = 'production'
    var elasticSearchIndex = 'opendocsg-opendoc-sp-self-help-centre'
    ...
    function getLunrIndex() {
        return fetch('/opendoc-sp-self-help-centre/assets/lunrIndex.json')
            .then(function (res) {
                    return res.json()
            })
            .then(function (json) {
    ...
    var generateResultHTML = function (result, i) {
        ...
        searchTitle.innerHTML = result.documentTitle || "PACE Academy Self Help Centre"
